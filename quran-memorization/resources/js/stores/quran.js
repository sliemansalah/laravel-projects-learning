...
export const useQuranStore = defineStore('quran', () => {
    ...
    async function fetchSurahs() {
        ...
        try {
            ...
            error.value = err.response ? .data ? .message || 'حدث خطأ في تحميل السور'
            throw err
        } finally {
            loading.value = false
        }
    ...
    async function fetchSurah(surahId) {
        ...
        try {
            ...
            error.value = err.response ? .data ? .message || 'حدث خطأ في تحميل السورة'
            throw err
        } finally {
            loading.value = false
        }
    ...
    async function fetchAyah(ayahId) {
        ...
        try {
            ...
            error.value = err.response ? .data ? .message || 'حدث خطأ في تحميل الآية'
            throw err
        } finally {
            loading.value = false
        }
